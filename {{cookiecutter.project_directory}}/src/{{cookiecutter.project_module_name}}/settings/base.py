...
ROOT_URLCONF = '{{ cookiecutter.project_module_name }}.urls'
WSGI_APPLICATION = '{{ cookiecutter.project_module_name }}.wsgi.application'
...
DEBUG_TOOLBAR_CONFIG = {
    'SHOW_TOOLBAR_CALLBACK': '{{ cookiecutter.project_module_name }}.settings.utils.show_toolbar',
}
